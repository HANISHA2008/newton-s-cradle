...
function setup() {
	...
	bob1 = Bodies.circle(-10,300,40,bob_options);
	World.add(world,bob1);
	
	bob2 = Bodies.circle(-50,300,40,bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(-90,300,40,bob_options);
	World.add(world,bob3);
	
	bob4 = Bodies.circle(-130,300,40,bob_options);
	World.add(world,bob4);

	bob5 = Bodies.circle(-170,300,40,bob_options);
